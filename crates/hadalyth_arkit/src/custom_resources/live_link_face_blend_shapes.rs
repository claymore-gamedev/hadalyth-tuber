...
pub struct LiveLinkFaceBlendShapes {
    ...
    #[var] pub head_yaw : f32,

    #[var] pub head_pitch : f32,

    #[var] pub head_roll : f32,

    #[var] pub left_eye_yaw : f32,

    #[var] pub left_eye_pitch : f32,

    #[var] pub left_eye_roll : f32,

    #[var] pub right_eye_yaw : f32,

    #[var] pub right_eye_pitch : f32,

    #[var] pub right_eye_roll : f32,
}
